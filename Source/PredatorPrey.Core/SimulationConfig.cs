...
public static class SimulationConfig
{
    ...
    /// </summary>
    public static float BaseFertility { get; set; } = 0.30f;

    /// <summary>
    /// Minimum fertility rate (adaptive fertility cannot go below this)
    /// </summary>
    public static float MinFertility { get; set; } = 0.10f;

    /// <summary>
    /// Maximum fertility rate (adaptive fertility cannot go above this)
    /// </summary>
    public static float MaxFertility { get; set; } = 0.70f;

    /// <summary>
    /// Target population density as ratio of total carrying capacity (0.0-1.0)
    /// Target ~500-1000 organisms for healthy genetic diversity
    /// </summary>
    public static float TargetPopulationDensity { get; set; } = 0.5f;

    /// <summary>
    /// Weight factor for local density influence on fertility (0.0-1.0)
    /// </summary>
    public static float LocalDensityWeight { get; set; } = 0.7f;

    /// <summary>
    /// Weight factor for global density influence on fertility (0.0-1.0)
    /// </summary>
    public static float GlobalDensityWeight { get; set; } = 0.3f;
    ...
    /// <summary>
    /// Enable parallel processing for simulation operations
    /// </summary>
    public static bool EnableParallelProcessing { get; set; } = true;
    
    /// <summary>
    /// Maximum degree of parallelism (-1 for default, 0 to disable, >0 for specific thread count)
    /// </summary>
    public static int MaxDegreeOfParallelism { get; set; } = -1; // Use all available cores
    
    /// <summary>
    /// Minimum population size before enabling parallel organism processing
    /// </summary>
    public static int ParallelProcessingThreshold { get; set; } = 100;
    ...
    public static void ResetToDefaults()
    {
        ...
        MinFertility = 0.10f;
        MaxFertility = 0.50f;
        TargetPopulationDensity = 0.01f;
        MaxFertility = 0.70f;
        LocalDensityWeight = 0.7f;
        GlobalDensityWeight = 0.3f;
